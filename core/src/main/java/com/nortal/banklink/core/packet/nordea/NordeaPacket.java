 ...
 */
public class NordeaPacket extends Packet {

    /** The mac name. */
    private String macName;

    /**
     * Instantiates a new nordea packet.
     * 
     * @param id
     *            the id
     * @param algorithm
    ...
    protected NordeaPacket(String id, Algorithm algorithm) {
        super(id, algorithm);
    }
    ...
    public boolean verify() throws BanklinkException {
        ...
        try {
            ...
            String macString = getParameterValue(macName);
     ...
     * (non-Javadoc)
     * 
     * @see com.nortal.banklink.core.packet.Packet#setMacName(java.lang.String)
     */
